...
@Component({
  selector: 'coscholasticsettings',
  templateUrl: './coscholasticsettings.component.html'
})
export class CoScholasticSettingsComponent {
  ...
  goToFormatives():void {
    this.router.navigate(['/coscholasticsettings']);
  }
